...
class myLoss(mx.operator.CustomOp):
...
@mx.operator.register("myLoss")
class myLossProp(mx.operator.CustomOpProp):
    def __init__(self, nNeighbors, alpha, nClass):
        super(myLossProp, self).__init__(need_top_grad=False)
    ...
    def list_auxiliary_states(self):
        ...
        'centroid_bias', 's_bias','neighbors_bias']
    ...
    def create_operator(self, ctx, shapes, dtypes):
        return myLoss(ctx, shapes, dtypes, self.nNeighbors,\
