...
class beaconLoss(mx.operator.CustomOp):
...
@mx.operator.register("beaconLoss")
class beaconLossProp(mx.operator.CustomOpProp):
    def __init__(self, nNeighbors, alpha, nClass):
        super(beaconLossProp, self).__init__(need_top_grad=False)
    ...
    def create_operator(self, ctx, shapes, dtypes):
        return beaconLoss(ctx, shapes, dtypes, self.nNeighbors,\
